...
<form class="form_container m-auto p-2 my-3" id="login_form">
    <div class="logo_container d-flex align-items-center">
        <img src="https://pathideamultiskill.com/images/logo.png" class='img-fluid' alt="Logo">
    </div>
    ...
    <div class="input_container">
        ...
        <input placeholder="name@mail.com" title="User Name" name="user_name" type="text" class="input_field"
            id="user_name">
    </div>
    <div class="input_container">
        ...
        <input placeholder="Password" title="Inpit title" name="user_pass" type="password" class="input_field"
            id="user_pass">
    </div>
...
<script>
    $(document).ready(function () {
        $("#login_form").submit(function (event) {
            ...
            $.ajax({
                url: "<?php echo base_url('logincontroller/Login_controller/check_login_with_password') ?>",
                type: "POST",
