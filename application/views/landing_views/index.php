...
<html lang="en">
    ...
    <head>
        ...
        <link href="assets/landing_assests/lib/animate/animate.min.css" rel="stylesheet">
        <link href="assets/landing_assests/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="assets/landing_assests/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="uploads/landing_img/carousel-1.jpg" class="img-fluid w-100" alt="Image">
            ...
            <div class="header-carousel-item">
                <img src="uploads/landing_img/carousel-2.jpg" class="img-fluid w-100" alt="Image">
                <div class="carousel-caption">
            ...
            <div class="container attractions-section py-5">
                ...
                <div class="owl-carousel attractions-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="attractions-item wow fadeInUp" data-wow-delay="0.2s">
                        <img src="uploads/landing_img/attraction-1.jpg" class="img-fluid rounded w-100" alt="">
                        <a href="#" class="attractions-name">Roller Coaster</a>
                    </div>
                    <div class="attractions-item wow fadeInUp" data-wow-delay="0.4s">
                        <img src="uploads/landing_img/attraction-2.jpg" class="img-fluid rounded w-100" alt="">
                        <a href="#" class="attractions-name">Carousel</a>
                    </div>
                    <div class="attractions-item wow fadeInUp" data-wow-delay="0.6s">
                        <img src="uploads/landing_img/attraction-3.jpg" class="img-fluid rounded w-100" alt="">
                        <a href="#" class="attractions-name">Arcade Game</a>
                    </div>
                    <div class="attractions-item wow fadeInUp" data-wow-delay="0.8s">
                        <img src="uploads/landing_img/attraction-4.jpg" class="img-fluid rounded w-100" alt="">
                ...
                <div class="row g-4">
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-1.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-1"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-2.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-2"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-3.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-3"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-4.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-4"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-5.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-5"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="gallery-item">
                            ...
                            <div class="search-icon">
                                <a href="uploads/landing_img/gallery-6.jpg" class="btn btn-light btn-lg-square rounded-circle" data-lightbox="Gallery-6"><i class="fas fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="#">
                                    <img src="uploads/landing_img/blog-2.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                                </a>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="#">
                                    <img src="uploads/landing_img/blog-3.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                                </a>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="#">
                                    <img src="uploads/landing_img/blog-1.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                                </a>
                                <div class="blog-category py-2 px-4">Insight</div>
                                <div class="blog-date"><i class="fas fa-clock me-2"></i>August 19, 2025</div>
                            </div>
                        ...
                        <div class="team-item p-4">
                            <div class="team-content">
                                <div class="d-flex justify-content-between border-bottom pb-4">
                                    ...
                                    <div>
                                        <img src="uploads/landing_img/team-1.jpg" class="img-fluid rounded" style="width: 100px; height: 100px;" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="team-item p-4">
                            <div class="team-content">
                                <div class="d-flex justify-content-between border-bottom pb-4">
                                    ...
                                    <div>
                                        <img src="uploads/landing_img/team-2.jpg" class="img-fluid rounded" style="width: 100px; height: 100px;" alt="">
                                    </div>
                                </div>
                                <div class="team-icon rounded-pill my-4 p-3">
                                    <a class="btn btn-primary btn-sm-square rounded-circle me-3" href=""><i class="fab fa-facebook-f"></i></a>
                        ...
                        <div class="team-item p-4">
                            <div class="team-content">
                                <div class="d-flex justify-content-between border-bottom pb-4">
                                    ...
                                    <div>
                                        <img src="uploads/landing_img/team-3.jpg" class="img-fluid rounded" style="width: 100px; height: 100px;" alt="">
                                    </div>
                                </div>
                                <div class="team-icon rounded-pill my-4 p-3">
                                    <a class="btn btn-primary btn-sm-square rounded-circle me-3" href=""><i class="fab fa-facebook-f"></i></a>
    ...
    <script src="assets/landing_assests/lib/wow/wow.min.js"></script>
    <script src="assets/landing_assests/lib/easing/easing.min.js"></script>
    <script src="assets/landing_assests/lib/waypoints/waypoints.min.js"></script>
    <script src="assets/landing_assests/lib/counterup/counterup.min.js"></script>
    <script src="assets/landing_assests/lib/lightbox/js/lightbox.min.js"></script>
    <script src="assets/landing_assests/lib/owlcarousel/owl.carousel.min.js"></script>
